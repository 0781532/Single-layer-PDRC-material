...
mater_1='PDMS_C2H6OSi';
mater_2='PDMS_C2H6OSi';
f_1=0.9;
T1=100;
Tamb=300;
Tdev=[250:5:350]';
...
Pheating=0;
%---------------------------------------------------------------------------------------------------------------------
[wl,N,K]=Maxwell_Garnet(mater_1,mater_2,f_1);  % Calculate n,k for mix by using Maxwell_Garnet funtion
...
FINAL=[T11 TRA Teq1 Pnet_amb1 Psun1 Patm1 Prad_amb1];