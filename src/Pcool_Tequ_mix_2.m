function [FINAL,FullAbsorption,Psun,Patm,Prad]=Pcool_Tequ_mix_2(mater_1,mater_2,f_1,f_2,f_3,hcon,Tamb,Tdev,Pheating,T1)
[wl,N,K]=Maxwell_Garnet_3mat(mater_1,mater_2,f_1,f_2,f_3);  % Calculate n,k for mix by using Maxwell_Garnet funtion
